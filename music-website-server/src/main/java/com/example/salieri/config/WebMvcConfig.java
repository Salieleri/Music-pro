...
public class WebMvcConfig extends WebMvcConfigurationSupport {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        if(OS.toLowerCase().startsWith("win")){
            ...
            registry.addResourceHandler("/img/SongPic/**")
                    .addResourceLocations("file:" + constant.RESOURCE_PATH_MAC + "/img/SongPic/");
            registry.addResourceHandler("/Song/**")
                    .addResourceLocations("file:" + constant.RESOURCE_PATH_MAC + "/Song/");
            registry.addResourceHandler("/img/Avator/**")
                    .addResourceLocations("file:" + constant.RESOURCE_PATH_MAC + "/img/Avator/");
            registry.addResourceHandler("/img/SongList/**")
                    .addResourceLocations("file:" + constant.RESOURCE_PATH_MAC + "/img/SongList/");
        }
    }
}
